...
function SignIn() {
  ...
  return (
    <>
      ...
      <p style={{ textAlign: 'center', maxWidth: '100%' }}>Do not violate the guidelines given by KARTHIK or you will be banned for life!</p>
    </>
  )
...
function ChatRoom() {
  ...
  return (<>
    ...
    <form onSubmit={sendMessage}>
      ...
      <button className="sendBtn" type="submit" disabled={!formValue}><img src="https://play-lh.googleusercontent.com/F5a3I0qOcUGHq6yYuEvpHGfAklwW3yAUyEWqgS-05k0QYwIogSZSSC08VDrAilKGWMs"/></button>
